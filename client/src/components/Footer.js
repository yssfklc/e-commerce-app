  ...
  return (
    <div className='bg-gray-800 px-10 py-5 mt-10 mx-auto text-gray-100' >
        <div className='flex border-b-4 border-b-gray-500 justify-evenly'>
            <div className='w-1/4 flex flex-col justify-center items-start px-5 max-md:w-32 max-md:px-1' >
            ...
            <div className='flex flex-col py-10 px-10'>
                <a href='# ' className='max-md:mb-2'>About Us</a>
                <br className='max-md:hidden'/>
                <a href='#' className='max-md:mb-2'>Careers</a>
                <a href='' className='md:hidden max-md:mb-2'>Contact Us</a>
            </div>
            <div className='w-1/4 flex flex-col justify-center items-start py-10 px-10 max-md:hidden'>
                <a href=''>Contact Us</a>
                <br/>
